  ...
  private projects: Project[] = [
    {
      ...
      description:
        'WCAG-compliant real-time collaboration tools in Angular across three products with WebSocket integration',
      tech: [
        'Angular',
        'WebSockets',
        'Spring Boot',
    ...
    },
    {
      ...
      description:
        'Internal React applications for Zendesk with NestJS Backend-for-Frontend layer to aggregate and normalize data',
    ...
    },
    {
      ...
      description:
        'AI-powered document feedback service integrated with Apryse Web Viewer for enhanced document processing',
      tech: [
        'Apryse Web Viewer',
        'Node.js',
        'AI/ML',
    ...
    },
    {
      ...
      description:
        'Highly customizable Google Maps application with custom markers, legends, and interactive features',
    ...
    },
    {
      ...
      description:
        'CPU-level branch prediction model using two-level adaptive predictor for speculative execution optimization',
      tech: [
        'C',
    ...
    },
    {
      ...
      description:
        'Android application for faculty members to manage schedules, track funds, and monitor assessments',
      tech: [
        'Android',
        'Java',
        'SQLite',
