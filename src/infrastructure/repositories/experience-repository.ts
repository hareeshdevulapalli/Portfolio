  ...
  private experiences: Experience[] = [
    {
      ...
      description:
        'Developing and launching WCAG-compliant real-time collaboration tools in Angular across three products, translating Figma designs into responsive, accessible interfaces.',
      achievements: [
    ...
    },
    {
      ...
      description:
        'Refactored component structures across 2 products during migration to latest Angular Material UI, customizing themes for brand consistency.',
      achievements: [
    ...
    },
    {
      ...
      description:
        'Built and maintained Cypress end-to-end test suites to validate FlowRight-driven onboarding and policy creation workflows.',
      achievements: [
    ...
    },
    {
      ...
      description:
        'Provided interactive dashboards using React, Node.js, and MongoDB to track robot tasks progress in real-time.',
      achievements: [
    ...
    },
    {
      ...
      description:
        'Designed and developed interactive brochures using React, dynamically transforming user input into visually appealing, data-driven formats.',
      achievements: [
