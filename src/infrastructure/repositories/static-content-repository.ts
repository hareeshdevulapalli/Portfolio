...
export class InMemoryHighlightRepository implements HighlightRepository {
  private highlights: Highlight[] = [
    ...
    },
    {
      ...
      description:
        'Reduced client-side complexity by 40% and improved load times by 70% through strategic optimizations',
    },
    {
      id: '3',
      icon: 'Palette',
      ...
      description:
        'Built real-time Threads/Notes collaboration tool powered by WebSockets with Spring Boot + Kotlin',
    },
    {
      id: '4',
      icon: 'Shield',
      ...
      description:
        'Designed Producer and Client Onboarding microservices with RESTful APIs and automated workflows',
    },
  ];
